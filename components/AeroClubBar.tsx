...
export default function AeroClubBar() {
  ...
  // Poll temperatures toutes les 10s
  useEffect(() => {
    const fetchTemp = () => {
    ...
    fetchTemp();
    const timer = setInterval(fetchTemp, 10000);
    ...
    <div className="min-h-screen bg-[#0a0f1c] text-slate-200 relative overflow-hidden">
        ...
        <div className="min-h-screen flex flex-col items-center px-4 pb-32">
          <div className="text-center pt-10 pb-6 relative w-full">
            ...
            <div className="flex items-center justify-center gap-4 mt-2">
              <span className={"text-xs font-bold " + (temperatures.frigo === null ? "text-slate-600" : (temperatures.frigo >= 6 && temperatures.frigo <= 8) ? "text-emerald-400" : (temperatures.frigo < 5 || temperatures.frigo > 9) ? "text-red-400" : "text-amber-400")}>
                {"🧊 Frigo " + (temperatures.frigo !== null ? temperatures.frigo.toFixed(1) + "°C" : "--")}
              </span>
              <span className={"text-xs font-bold " + (temperatures.congelateur === null ? "text-slate-600" : (temperatures.congelateur >= -18 && temperatures.congelateur <= -14) ? "text-emerald-400" : (temperatures.congelateur < -19 || temperatures.congelateur > -13) ? "text-red-400" : "text-amber-400")}>
      ...
      {view === "admin" && (
        <div className="min-h-screen p-4 pb-10 max-w-2xl mx-auto">
          ...
          {/* Temperatures frigo/congelateur \u2014 temps reel */}
